...
public class Connection {
	...
	public <T extends ProcessedResponse> T send  (Request request, Class<T> cls) throws TransportException, InvalidResourceOwnerException, SystemException, UnprocessableEntityException {
